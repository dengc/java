...
public class videoStruc {
	...
	public void readAndextractSound() throws PlayWaveException, FileNotFoundException, IOException{
		...
		String queryFolder = "/Users/dengchufan/Downloads/CS576Hw/Project/query/";
		String dbFolder = "/Users/dengchufan/Downloads/CS576Hw/Project/db/";
		if(type == 0)
			soundFileName= dbFolder + videoname + "/" + videoname + ".wav";
		else
			soundFileName= queryFolder + videoname + "/" + videoname  + ".wav";
		try {
	...
	public void readAndextractVideo() {
		for(int i = 0;i < framenum;i++) {
			...
			String queryFolder = "/Users/dengchufan/Downloads/CS576Hw/Project/query/";
			if(type == 0)
				imgpath= dbFolder + videoname + "/" + videoname + num + ".rgb";
			else
				imgpath= queryFolder + videoname + "/" + videoname + num + ".rgb";
